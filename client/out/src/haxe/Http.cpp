...
{
HX_STACK_FRAME("haxe.Http","new",0x57ac51e2,"haxe.Http.new","/usr/local/lib/haxe/std/haxe/Http.hx",88,0x2a90892a)
HX_STACK_THIS(this)
...
::haxe::Http Http_obj::setHeader( ::String header,::String value){
	HX_STACK_FRAME("haxe.Http","setHeader",0x34bd0dd1,"haxe.Http.setHeader","/usr/local/lib/haxe/std/haxe/Http.hx",110,0x2a90892a)
	HX_STACK_THIS(this)
	...
	bool run(Dynamic h){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","/usr/local/lib/haxe/std/haxe/Http.hx",111,0x2a90892a)
		HX_STACK_ARG(h,"h")
		{
			HX_STACK_LINE(111)
	...
	struct _Function_1_2{
		inline static Dynamic Block( ::String &header,::String &value){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/local/lib/haxe/std/haxe/Http.hx",112,0x2a90892a)
			{
...
::haxe::Http Http_obj::setParameter( ::String param,::String value){
	HX_STACK_FRAME("haxe.Http","setParameter",0x96e033e5,"haxe.Http.setParameter","/usr/local/lib/haxe/std/haxe/Http.hx",128,0x2a90892a)
	HX_STACK_THIS(this)
	...
	int __ArgCount() const { return 1; }
	bool run(Dynamic p){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","/usr/local/lib/haxe/std/haxe/Http.hx",129,0x2a90892a)
		HX_STACK_ARG(p,"p")
		{
			HX_STACK_LINE(129)
	...
	struct _Function_1_2{
		inline static Dynamic Block( ::String &param,::String &value){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/local/lib/haxe/std/haxe/Http.hx",130,0x2a90892a)
			{
				hx::Anon __result = hx::Anon_obj::Create();
...
{
		HX_STACK_FRAME("haxe.Http","request",0xb2c949d1,"haxe.Http.request","/usr/local/lib/haxe/std/haxe/Http.hx",195,0x2a90892a)
		HX_STACK_THIS(this)
		...
		int __ArgCount() const { return 1; }
		Void run(::String e){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","/usr/local/lib/haxe/std/haxe/Http.hx",336,0x2a90892a)
			HX_STACK_ARG(e,"e")
			{
				HX_STACK_LINE(340)
...
{
		HX_STACK_FRAME("haxe.Http","customRequest",0x68e97fa0,"haxe.Http.customRequest","/usr/local/lib/haxe/std/haxe/Http.hx",371,0x2a90892a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(post,"post")
		...
		if ((tmp30)){
			...
			if ((tmp32)){
				...
				if ((tmp34)){
					...
					int __ArgCount() const { return 1; }
					bool run(Dynamic h){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","/usr/local/lib/haxe/std/haxe/Http.hx",477,0x2a90892a)
						HX_STACK_ARG(h,"h")
						{
							HX_STACK_LINE(477)
...
{
		HX_STACK_FRAME("haxe.Http","readHttpResponse",0x6bff43dd,"haxe.Http.readHttpResponse","/usr/local/lib/haxe/std/haxe/Http.hx",534,0x2a90892a)
		HX_STACK_THIS(this)
		HX_STACK_ARG(api,"api")
		HX_STACK_ARG(sock,"sock")
		HX_STACK_LINE(536)
...
bool Http_obj::readChunk( ::EReg chunk_re,::haxe::io::Output api,::haxe::io::Bytes buf,int len){
	HX_STACK_FRAME("haxe.Http","readChunk",0xeebfa239,"haxe.Http.readChunk","/usr/local/lib/haxe/std/haxe/Http.hx",674,0x2a90892a)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.Http","onData",0x4f093aa7,"haxe.Http.onData","/usr/local/lib/haxe/std/haxe/Http.hx",740,0x2a90892a)
		HX_STACK_THIS(this)
...
Void run(::String msg){
{
		HX_STACK_FRAME("haxe.Http","onError",0x77abd4ab,"haxe.Http.onError","/usr/local/lib/haxe/std/haxe/Http.hx",750,0x2a90892a)
		HX_STACK_THIS(this)
...
Void run(int status){
{
		HX_STACK_FRAME("haxe.Http","onStatus",0xf341a4ef,"haxe.Http.onStatus","/usr/local/lib/haxe/std/haxe/Http.hx",760,0x2a90892a)
		HX_STACK_THIS(this)
