...
{
HX_STACK_FRAME("haxe.Serializer","new",0xcdbbc7ec,"haxe.Serializer.new","/usr/local/lib/haxe/std/haxe/Serializer.hx",100,0xdc8a8f60)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(101)
...
::String Serializer_obj::toString( ){
	HX_STACK_FRAME("haxe.Serializer","toString",0x95bdfda0,"haxe.Serializer.toString","/usr/local/lib/haxe/std/haxe/Serializer.hx",115,0xdc8a8f60)
	HX_STACK_THIS(this)
	HX_STACK_LINE(116)
...
{
		HX_STACK_FRAME("haxe.Serializer","serializeString",0xd565bc5d,"haxe.Serializer.serializeString","/usr/local/lib/haxe/std/haxe/Serializer.hx",152,0xdc8a8f60)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(153)
...
bool Serializer_obj::serializeRef( Dynamic v){
	HX_STACK_FRAME("haxe.Serializer","serializeRef",0x0b8ed647,"haxe.Serializer.serializeRef","/usr/local/lib/haxe/std/haxe/Serializer.hx",171,0xdc8a8f60)
	HX_STACK_THIS(this)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(175)
	{
...
{
		HX_STACK_FRAME("haxe.Serializer","serializeFields",0x44c42205,"haxe.Serializer.serializeFields","/usr/local/lib/haxe/std/haxe/Serializer.hx",208,0xdc8a8f60)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(209)
		{
...
{
		HX_STACK_FRAME("haxe.Serializer","serialize",0x3cea866c,"haxe.Serializer.serialize","/usr/local/lib/haxe/std/haxe/Serializer.hx",227,0xdc8a8f60)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(227)
		{
