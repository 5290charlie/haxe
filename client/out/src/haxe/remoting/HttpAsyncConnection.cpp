...
::haxe::remoting::AsyncConnection HttpAsyncConnection_obj::resolve( ::String name){
	HX_STACK_FRAME("haxe.remoting.HttpAsyncConnection","resolve",0x939601cd,"haxe.remoting.HttpAsyncConnection.resolve","/usr/local/lib/haxe/std/haxe/remoting/HttpAsyncConnection.hx",34,0xd00a5dec)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.remoting.HttpAsyncConnection","setErrorHandler",0xd4bc9f85,"haxe.remoting.HttpAsyncConnection.setErrorHandler","/usr/local/lib/haxe/std/haxe/remoting/HttpAsyncConnection.hx",40,0xd00a5dec)
		HX_STACK_THIS(this)
		HX_STACK_ARG(h,"h")
		HX_STACK_LINE(41)
		Dynamic tmp = this->__data;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("haxe.remoting.HttpAsyncConnection","call",0xd654831d,"haxe.remoting.HttpAsyncConnection.call","/usr/local/lib/haxe/std/haxe/remoting/HttpAsyncConnection.hx",44,0xd00a5dec)
		HX_STACK_THIS(this)
		...
		Void run(::String response){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","/usr/local/lib/haxe/std/haxe/remoting/HttpAsyncConnection.hx",55,0xd00a5dec)
