...
{
HX_STACK_FRAME("sys.net.Host","new",0x056496ac,"sys.net.Host.new","/usr/local/lib/haxe/std/cpp/_std/sys/net/Host.hx",29,0xbef41ec0)
HX_STACK_THIS(this)
...
HX_STACK_FRAME("sys.net.Host","__init__",0xecfcc384,"sys.net.Host.__init__","/usr/local/lib/haxe/std/cpp/_std/sys/net/Host.hx",45,0xbef41ec0)
{
	HX_STACK_LINE(46)
...
::String Host_obj::toString( ){
	HX_STACK_FRAME("sys.net.Host","toString",0xe5efb6e0,"sys.net.Host.toString","/usr/local/lib/haxe/std/cpp/_std/sys/net/Host.hx",33,0xbef41ec0)
	HX_STACK_THIS(this)
	HX_STACK_LINE(34)
