...
{
HX_STACK_FRAME("sys.net.Socket","new",0x202a8cf7,"sys.net.Socket.new","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",127,0x0bdbd1d5)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(128)
...
{
		HX_STACK_FRAME("sys.net.Socket","close",0x18d3680f,"sys.net.Socket.close","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",133,0x0bdbd1d5)
		HX_STACK_THIS(this)
		HX_STACK_LINE(134)
...
{
		HX_STACK_FRAME("sys.net.Socket","write",0xa0c9bd36,"sys.net.Socket.write","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",151,0x0bdbd1d5)
		HX_STACK_THIS(this)
		...
		struct _Function_1_1{
			inline static Array< unsigned char > Block( ::String &content){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",152,0x0bdbd1d5)
				{
					HX_STACK_LINE(152)
...
{
		HX_STACK_FRAME("sys.net.Socket","connect",0x1ee69001,"sys.net.Socket.connect","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",156,0x0bdbd1d5)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("sys.net.Socket","shutdown",0x9b2f3c9f,"sys.net.Socket.shutdown","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",170,0x0bdbd1d5)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("sys.net.Socket","setTimeout",0x1b505368,"sys.net.Socket.setTimeout","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",201,0x0bdbd1d5)
		HX_STACK_THIS(this)
