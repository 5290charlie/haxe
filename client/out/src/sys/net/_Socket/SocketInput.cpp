...
{
HX_STACK_FRAME("sys.net._Socket.SocketInput","new",0x5fe92abb,"sys.net._Socket.SocketInput.new","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",31,0x0bdbd1d5)
HX_STACK_THIS(this)
HX_STACK_ARG(s,"s")
{
	HX_STACK_LINE(31)
...
int SocketInput_obj::readByte( ){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readByte",0xee593543,"sys.net._Socket.SocketInput.readByte","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",34,0x0bdbd1d5)
	HX_STACK_THIS(this)
	HX_STACK_LINE(35)
...
int SocketInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
	HX_STACK_FRAME("sys.net._Socket.SocketInput","readBytes",0x9fb565d0,"sys.net._Socket.SocketInput.readBytes","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",47,0x0bdbd1d5)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("sys.net._Socket.SocketInput","close",0xbbc7fed3,"sys.net._Socket.SocketInput.close","/usr/local/lib/haxe/std/cpp/_std/sys/net/Socket.hx",64,0x0bdbd1d5)
		HX_STACK_THIS(this)
		HX_STACK_LINE(65)
		this->super::close();
		HX_STACK_LINE(66)
