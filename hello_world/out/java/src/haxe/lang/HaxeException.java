...
public class HaxeException extends java.lang.RuntimeException
{
	...
	public static java.lang.RuntimeException wrap(java.lang.Object obj)
	{
		...
		//line 80 "/usr/local/lib/haxe/std/java/internal/Exceptions.hx"
		...
		else
		{
			...
			{
				//line 83 "/usr/local/lib/haxe/std/java/internal/Exceptions.hx"
				ret = new haxe.lang.HaxeException(obj, haxe.lang.Runtime.toString(obj), null);
			}
			else
			{
				//line 84 "/usr/local/lib/haxe/std/java/internal/Exceptions.hx"
				if (( obj instanceof java.lang.Throwable )) 
				{
					//line 85 "/usr/local/lib/haxe/std/java/internal/Exceptions.hx"
					ret = new haxe.lang.HaxeException(obj, null, ((java.lang.Throwable) (obj) ));
				}
				else
				{
					//line 87 "/usr/local/lib/haxe/std/java/internal/Exceptions.hx"
